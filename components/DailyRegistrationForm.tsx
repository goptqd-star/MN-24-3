    ...
    <div>
        ...
        <div className="space-y-4 p-4 border border-gray-200 dark:border-gray-700 rounded-lg bg-gray-50 dark:bg-gray-800/50">
            <div className="flex items-center justify-between gap-x-4">
                ...
                <CustomDatePicker value={date} onChange={(newDate) => { setDate(newDate); setIsSundayMessageVisible(false); }} min={!isEditing ? formatDate(new Date()) : undefined} disabled={isEditing} className="flex-grow min-w-0" />
            </div>
        ...
        <div className="space-y-4 p-4 border border-gray-200 dark:border-gray-700 rounded-lg">
            <div className="flex items-center justify-between gap-x-4">
                ...
                <CustomDatePicker value={breakfastDate} onChange={setBreakfastDate} min={!isEditing ? formatDate(new Date()) : undefined} className="flex-grow min-w-0" />
            </div>
