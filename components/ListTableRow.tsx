...
const ListTableRow: React.FC<ListTableRowProps> = ({ data, isHighlighted }) => {
    const highlightClass = isHighlighted ? 'highlight-update' : '';
    return (
        <tr data-classname={data.className} className={`table-row-item ${highlightClass} hover:bg-gray-100 dark:hover:bg-gray-700 transition-colors duration-150`}>
