        ...
        <div className="space-y-8">
            ...
            {hasMore && !isLoading && (
                <div className="mt-6 text-center">
                    <button onClick={() => fetchLogs(true)} disabled={isContextLoading} className="px-4 py-2 text-sm font-medium rounded-md text-white bg-teal-600 hover:bg-teal-700 disabled:bg-teal-400">
                        {isContextLoading ? 'Đang tải...' : 'Tải thêm'}
                    </button>
                </div>
            )}
        </div>
