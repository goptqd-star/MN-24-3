...
// FIX: Replaced non-existent RegistrationContext with DataContext, AuthContext, and UIContext.
...
const AnnouncementsPage: React.FC = () => {
    // FIX: Replaced useRegistrationState and useRegistrationDispatch with useData, useAuth, and useUI.
    const { announcements, addAnnouncement, updateAnnouncement, deleteAnnouncement, markAnnouncementsAsRead } = useData();
    ...
    const handleToggleExpand = (announcement: Announcement) => {
        ...
        if (currentUser && !announcement.readBy.includes(currentUser.id)) {
